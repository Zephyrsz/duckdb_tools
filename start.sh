...
_cfg_auto_connect="${DUCKDB_AUTO_CONNECT-}"
...
[[ -n "$_cfg_auto_connect" ]] && DUCKDB_AUTO_CONNECT="$_cfg_auto_connect"
...
unset _cfg_host _cfg_backend_port _cfg_frontend_port _cfg_data _cfg_database _cfg_auto_connect _cfg_rds_root _cfg_metadata _cfg_rds_db _cfg_rds_metadata
